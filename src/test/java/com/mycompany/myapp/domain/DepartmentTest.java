...
class DepartmentTest {
    ...
    @Test
    void parentDepartmentTest() {
        Department department = getDepartmentRandomSampleGenerator();
        Department departmentBack = getDepartmentRandomSampleGenerator();

        department.setParentDepartment(departmentBack);
        assertThat(department.getParentDepartment()).isEqualTo(departmentBack);

        department.parentDepartment(null);
        assertThat(department.getParentDepartment()).isNull();
    }
}
