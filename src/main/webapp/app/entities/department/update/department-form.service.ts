...
type DepartmentFormGroupContent = {
  ...
  field: FormControl<IDepartment['field']>;
  parentDepartment: FormControl<IDepartment['parentDepartment']>;
};
...
export class DepartmentFormService {
  createDepartmentFormGroup(department: DepartmentFormGroupInput = { id: null }): DepartmentFormGroup {
    ...
    return new FormGroup<DepartmentFormGroupContent>({
      ...
      field: new FormControl(departmentRawValue.field),
      parentDepartment: new FormControl(departmentRawValue.parentDepartment),
    });
  }
