...
import { sampleWithRequiredData } from '../item-catalogue.test-samples';
...
describe('ItemCatalogue Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ItemCatalogueComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.itemCatalogues()[0]).toEqual(expect.objectContaining({ id: 24609 }));
  });

  describe('trackId', () => {
    it('should forward to itemCatalogueService', () => {
      const entity = { id: 24609 };
      jest.spyOn(service, 'getItemCatalogueIdentifier');
      const id = comp.trackId(entity);
      expect(service.getItemCatalogueIdentifier).toHaveBeenCalledWith(entity);
