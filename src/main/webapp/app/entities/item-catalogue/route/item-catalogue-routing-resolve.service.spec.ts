...
import itemCatalogueResolve from './item-catalogue-routing-resolve.service';

describe('ItemCatalogue routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: ItemCatalogueService;
  let resultItemCatalogue: IItemCatalogue | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IItemCatalogue returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        itemCatalogueResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultItemCatalogue).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IItemCatalogue>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
