...
import { CatalogueService, EntityArrayResponseType } from '../service/catalogue.service';
...
export class CatalogueComponent implements OnInit {
  ...
  trackId = (item: ICatalogue): number => this.catalogueService.getCatalogueIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.catalogues.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: ICatalogue[] | null): ICatalogue[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.catalogueService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
