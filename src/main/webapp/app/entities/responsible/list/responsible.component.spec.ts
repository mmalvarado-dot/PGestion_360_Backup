...
import { sampleWithRequiredData } from '../responsible.test-samples';
...
describe('Responsible Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.responsibles()[0]).toEqual(expect.objectContaining({ id: 24783 }));
  });

  describe('trackId', () => {
    it('should forward to responsibleService', () => {
      const entity = { id: 24783 };
      jest.spyOn(service, 'getResponsibleIdentifier');
      const id = comp.trackId(entity);
      expect(service.getResponsibleIdentifier).toHaveBeenCalledWith(entity);
