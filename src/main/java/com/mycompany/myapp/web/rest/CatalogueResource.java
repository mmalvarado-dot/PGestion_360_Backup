...
public class CatalogueResource {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(CatalogueResource.class);
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<CatalogueDTO>> createCatalogue(@Valid @RequestBody CatalogueDTO catalogueDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/{id}")
    public Mono<ResponseEntity<CatalogueDTO>> updateCatalogue(
    ...
    public Mono<ResponseEntity<CatalogueDTO>> partialUpdateCatalogue(
        @PathVariable(value = "id", required = false) final Long id,
        ...
        return catalogueRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<CatalogueDTO> result = catalogueService.partialUpdate(catalogueDTO);
    ...
    public Mono<ResponseEntity<List<CatalogueDTO>>> getAllCatalogues(
        ...
        return catalogueService
            .countAll()
            .zipWith(catalogueService.findAll(pageable).collectList())
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<CatalogueDTO>> getCatalogue(@PathVariable("id") Long id) {
        LOG.debug("REST request to get Catalogue : {}", id);
        Mono<CatalogueDTO> catalogueDTO = catalogueService.findOne(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteCatalogue(@PathVariable("id") Long id) {
